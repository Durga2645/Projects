...
<body>
	<div style='text-align:center;background-image: linear-gradient(to right, #141e30, #243b55);width:35%;margin-left:400px;margin-top:30px;border-radius:10px'> 
		<div style="font-size:25px;color:white">Select Book</div><br>
		<form method="post" action="./controller/selectBook">
			...
			<input type="submit" value="Select" style="width:150px;background-image: linear-gradient(to right, #FFD194, #D1913C);"><br><br>
		</form>
	</div>
</body>
</html>