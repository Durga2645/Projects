...
<body>
	<div>
		...
		<form method="post" action="./../controller/studentPasswordReset">
			...
			<input type="password" placeholder="Enter the above password again"  size=30 name="password2" required><br><br>
